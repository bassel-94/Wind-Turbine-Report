...
Ultimately, distinguishing outliers from anomalies would be important in further studies. In addition, studying in detail the anomalies detected with our method should be carried out to fine tune the threshold. Similar modeling steps could be performed on different turbines which would confirm the scalability of the model. Future work could also be conducted on all of the wind-turbine's components in order to trace back the failure to a specific system.
